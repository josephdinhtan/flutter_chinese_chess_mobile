...
class Fen {
  ...
  static String toFen(
    ...
    // King's rook castling and passing pawn sign
    fen += ' - - ';
  ...
  static ChessPositionMap? positionFromFen(String fen) {
    ...
    final String counterMark; // No capture moves and turns
    ...
    try {
      ...
      return ChessPositionMap(pieces, sideToMove, recorder);
    } catch (e) {
      return null;
    }
  }
  ...
  static String positionToCrManualBoard(ChessPositionMap origin) {
    //
    const pieces = 'RNBAKABNRCCPPPPPrnbakabnrccppppp';
