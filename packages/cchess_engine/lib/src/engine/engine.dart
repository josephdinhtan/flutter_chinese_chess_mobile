...
class EngineInfo extends Response {
  ...
  // String? score(
  //     ChessPositionMap position, bool playerSideIsRed, bool negative) {
  //   //
  //   final playerSide = playerSideIsRed ? 'w' : 'b';
  ...
  //     return 'tình huống $score ($judge)';
  //   }

  //   // mate
  //   return score > 0 ? '$score Thắng' : '${-score} Thua';
  // }
